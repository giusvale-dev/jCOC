            ...
            if(!isValidToken) {
                ...
                if(cocAccount != null) {
                    ...
                    if(myIP != null) {
                        ...
                        throw new JCocException("You can create only 10 keys, please delete someone on your developer account");
                    }
                    throw new JCocException("I can't find your public IP, please register an API_TOKEN on https://developer.clashofclans.com/ and use it");
                } 
