...
public class CurrentWarClan extends GenericClan{
    ...
    @JsonProperty
    private List<CurrentWarMember> members;
     ...
     * @return the members
     */
    public List<CurrentWarMember> getMembers() {
        return members;
    }
     ...
     */
    public void setMembers(List<CurrentWarMember> members) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        CurrentWarClan other = (CurrentWarClan) obj;
